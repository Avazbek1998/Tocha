...
sr.reveal('.about-left , .tarifs-head , .join , .email-items-left , .footer-left' ,{origin:'left'})
sr.reveal('.about-right , .reviews , .email-items-right , .footer-right-wrap',{origin:'right'})
